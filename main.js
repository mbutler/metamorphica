...
const mammals = [
    { range: [1], name: "Aardconstk or anteater" },
    { range: [9], name: "Bat" },
...
const bloodSubstitution = [
    { range: [1], name: "Amoeba or protoplasm" },
    { range: [11], name: "Lava or molten metal" },
    { range: [2], name: "Hemolymph fluid" },
    { range: [12], name: "Leeches or maggots" },
    { range: [3], name: "Respiratory proteins" },
    { range: [13], name: "Mercury" },
    { range: [4], name: "Acid" },
    { range: [14], name: "Noxious gas" },
    { range: [5], name: "Ichor" },
    { range: [15], name: "Powder or sand" },
...
const colourBlind = [
    ...
    { range: [4], name: "Tritanopia (blue and green look the same; violet and yellow look the same)." }
]

const decreasedCapability = [
    { range: [1, 2], name: "Agility, dexterity, and/or reflexes" },
    { range: [3], name: "Balance, co, ordination, and/or flexibility" },
    { range: [4, 5], name: "Health, stamina, and/or toughness" },
...
const describe = {
    ...
    "Antennae": "This mutant has a set of two or more antennae extending from its head, which it can use to feel and possibly smell and taste or otherwise augment its constious senses.",
    ...
    "Exotic Genitalia": "This mutant’s sexual organs include unusual shapes and structures, and may include erectile tissue in constious places all over the body or in strange locations.",
    ...
    "Adhesive Touch": "This mutant has microscopic suckers and hooks on its hands and feet, and perhaps other areas of its body, which allow it to stick to walls and walk or crawl on ceilings.",

    "Allergies": "This mutant is extremely allergic to " + pick(allergies) + ".",
    "Ambidextrous": "This mutant can use both sides of its body with the same ability as a right-handed person using their right hand (or leg).",
    "Anaerobic": "This mutant does not require oxygen and does not breathe air or water.",
    "Aquatic Adaptation": "This mutant’s body is adapted to living underwater. It may have gills or a blowhole, flippers, a tail, or any other feature that would help it function aquatically.",
    "Bad Breath": "This mutant’s mouth exudes a horrifying stench, which it is unable to mask or alleviate in any way.",
    "Bioluminescent": "Part of this mutant’s body generates a cold, softly glowing light. There is a chance the mutant can change the colour of its " + pick(bioluminescence) + " bioluminescence to " + pick(colours) + ".",
    "Blind": "If this mutant has eyes, they do not work.",
    "Blood Substitution": "Instead of blood, this mutant has " + pick(bloodSubstitution) + " in its veins.",
    "Buoyancy": "Because it has an air bladder it can inflate, or because of its cell structure, this mutant floats in water, even fresh water.",
    "Chameleoline Skin": "This mutant’s skin can change colour to mimic its surroundings, providing camouflage when it is not moving quickly.",
    "Chronic Pain": "This mutant has pains in its body that never go away. It must take large quantities of drugs in order to get any relief, though some days the pain is worse than others.",
    "Cocoon": "This mutant may create a cocoon out of secretions and whatever else it needs, and is then able to hibernate inside it.",
    "Cold Blooded": "This mutant suffers from poikilothermia, or it is naturally cold-blooded, like a reptile. It will be adversely affected by temperatures lower than 30°C (86°F).",
    "Colour Blind": "This mutant cannot distinguish between certain colours and has " + pick(colourBlind),
    "Cracking Joints": "This mutant’s joints are constantly cracking as it moves, making it hard to move silently. This is not painful to the mutant in any way, and does not wear down the joints.",
    "Deaf": "This mutant is unable to hear.",
    "Decreased Metabolism": "This mutant’s reactions are slightly slower than normal. It may also suffer from a weakened immune system, an increased susceptibility to cold, brittle hair and nails, constipation, dry skin, irregular menstruation, poor memory, and unexplained weight gain.",
    "Decreased Physical Capability": "This mutant has " + pick(decreasedCapability) + " 1/" + _.random(2, 5) + " lower than the average specimen of it type.",
    "Defensive Barbs": "When threatened, this mutant can raise dangerous barbs, horns, spikes, or spines upon its skin. These function as weapons and protection, and are concealed when not in use.",
    "Diabetes": "This mutant has a problem with high blood sugar levels, probably due to an inability to produce insulin or a resistance to it. Diabetes can cause blindness, heart disease, obesity, and other health problems, including diabetic ketoacidosis, which can be fatal if untreated.",
